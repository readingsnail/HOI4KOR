...
class YmlConvertSupporter(object) :
    def __init__(self) :
        ...
        try :
            ## print("Current directory : " + os.getcwd()+"\\HOI4KRconfig.ini")
            _configfile = open("HOI4KR_Yml2Pro_config.ini" , 'r', encoding='UTF-8' )
            self.config.read("HOI4KR_Yml2Pro_config.ini", encoding='UTF-8' ) ## this one recieves name of file
            self.noconfig = False
            _configfile.close()
